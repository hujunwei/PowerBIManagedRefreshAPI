...
$groupID = "7c4bd85f-1a09-40f4-8ea9-dcbccabc2fac" # the ID of the group that hosts the dataset. Use "me" if this is your My Workspace
$datasetID = "1fbd2512-d72c-4505-be54-260ebc56de43" # the ID of the dataset that hosts the dataset
...
$clientId = "1452b7ac-4971-4a70-9cf6-ad4cf00075b9" 
...
{
       $adal = "${env:ProgramFiles(x86)}\WindowsPowerShell\Modules\Azure\5.1.2\Automation\Microsoft.IdentityModel.Clients.ActiveDirectory.dll"
 
       $adalforms = "${env:ProgramFiles(x86)}\WindowsPowerShell\Modules\Azure\5.1.2\Automation\Microsoft.IdentityModel.Clients.ActiveDirectory.WindowsForms.dll"
...
Invoke-RestMethod -Uri $uri -Headers $authHeader -Method POST -Verbose -O refreshStatus.txt


# Check the refresh history
$uri = "https://api.powerbi.com/v1.0/$groupsPath/datasets/$datasetID/refreshes"
Invoke-RestMethod -Uri $uri -Headers $authHeader -Method GET -Verbose -O refreshesHistory.txt